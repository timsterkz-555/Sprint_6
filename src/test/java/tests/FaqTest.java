...
class FaqTest extends BaseTest {
    ...
    @DisplayName("При нажатии на вопрос FAQ отображается соответствующий ответ")
    @ParameterizedTest(name = "Вопрос FAQ с индексом {0}")
    @MethodSource("faqData")
    void testFaqAnswerIsDisplayed(int questionIndex, String expectedAnswer) {
        ...
        assertEquals(expectedAnswer, actualAnswer, "Текст ответа FAQ не соответствует ожидаемому");
    }
}
